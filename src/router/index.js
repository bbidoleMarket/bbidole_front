...
import PostReportDetail from "../pages/PostReportDetail.vue";
...
const routes = [
  ...
  {
    path: "/report/chat_room/:chatRoomId",
    name: "ChatRoomReport",
    component: () => import("@/pages/ReportPage.vue"),
    meta: { requiresAuth: true, viewType: ReportStatus.CHAT_ROOM },
  },
  {
    path: "/report/post/:postId",
    name: "PostReport",
    component: () => import("@/pages/ReportPage.vue"),
    meta: { requiresAuth: true, viewType: ReportStatus.POST },
  },
  {
    path: "/me/edit",
  ...
  {
    path: "/admin/report/userdetail/:reportId",
    name: "UserReportDetail",
    component: UserReportDetail,
    meta: { requiresAdmin: true },
  },
  {
    path: "/admin/report/postdetail/:reportId",
    name: "PostReportDetail",
    component: PostReportDetail,
    meta: { requiresAdmin: true },
  },
];
