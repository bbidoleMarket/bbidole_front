<template>
  <div class="max-w-2xl mx-auto px-4 py-6">
    ...
    <form @submit.prevent="submitForm" class="space-y-6" novalidate>
      ...
      <div>
        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">상품 이미지</label>
        <div class="flex items-center justify-center w-full">
          ...
          >
            ...
            <div v-else class="h-full flex items-center justify-center">
              <img :src="imagePreview" alt="상품 이미지 미리보기" class="max-h-full max-w-full object-contain" />
            </div>
            <input
              id="image"
              type="file"
      ...
      <!-- 상세 설명 -->
      <div>
        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">상세 설명</label>
        <textarea
          id="description"
