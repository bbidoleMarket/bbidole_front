<template>
    <div class="">
        <div class="max-w-2xl mx-auto overflow-y-auto space-y-6">
            <p
                class="relative mx-auto py-2 text-center text-3xl font-bold font-jua"
            >
                상세 정보
            </p>
            <div class="relative w-40 h-40 mx-auto">
                ...
                >
                    ...
                    <span
                        class="text-sm text-gray-700 font-hahmlet font-semibold"
                    >
                        {{
        ...
        >
            ...
            <div>
                <div class="relative mb-6">
                    <!-- 중앙 정렬 제목 -->
                    <h2 class="text-3xl font-bold font-jua text-center">
                        후기
                    </h2>
                ...
                <div
                    class="space-y-6 overflow-y-auto max-h-80 hidden-scroll-bar"
                >
                    <!-- 후기 카드 반복 -->
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                :src="
                                    post.imageUrl || '@/assets/icon_bbidole.svg'
                                "
                                alt="product"
                        ...
                        <div class="">
                            <p
                                class="font-hahmlet font-bold text-gray-900 truncate"
                            >
                                {{ post.title || "물품 제목" }}
                            </p>
