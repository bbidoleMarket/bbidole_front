  ...
  <div class="min-h-screen bg-[#FCFCF2] flex">
    ...
    <main class="flex-1 p-12">
      ...
      <section class="grid grid-cols-4 gap-6 mb-10">
        <div class="rounded-2xl shadow p-6 bg-white flex flex-col items-center">
        ...
        <div class="rounded-2xl shadow p-6 bg-white flex flex-col items-center">
          <div class="font-semibold text-lg mb-2">신고/문의</div>
          <div class="text-2xl font-extrabold text-[#e36262]">6</div>
        </div>
      </section>
...
onMounted(async () => {
  ...
  console.log(totalSub.value);
  console.log(totalProduct.value);
  console.log(totalCompleted.value);
  console.log(recentItems.value);
});
